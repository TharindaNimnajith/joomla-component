...
?>
<form action="index.php?option=com_joomla_component&view=joomla_components" method="post" name="adminForm"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="name break-word">
								<?php if ($canEdit) : ?>
                                    <a href="<?php echo Route::_('index.php?option=com_joomla_component&task=joomla_component.edit&id=' . (int) $item->id); ?>"
                                       title="<?php echo Text::sprintf('COM_JOOMLA_COMPONENTS_EDIT_JOOMLA_COMPONENT', $this->escape($item->title)); ?>">
